...
Простой локальный патч для приложения **Gimbal Pro 2** / `com.jxrobot.android.smoothcam`.
...
1. Установите оригинальное приложение [Gimbal Pro 2 v3.4.8.32](https://play.google.com/store/apps/details?hl=en&id=com.jxrobot.android.smoothcam) на телефон.
...
Она не относится к приложению Gimbal Pro 2, его APK, ресурсам, коду, названию или другим файлам правообладателя.
...
Репозиторий не связан с разработчиками Gimbal Pro 2 и не содержит их файлов. Чтобы распространять готовый измененный APK, нужно отдельное право от владельца приложения.
